...
|---------|--------------|-----------|-------------|
| **index.html** | 🏠 Основная структура страницы | ~3 KB | ⭐⭐⭐⭐⭐ |
| **style.css** | 💅 Все стили и анимации | ~8 KB | ⭐⭐⭐⭐⭐ |
| **script.js** | 🎮 Вся интерактивность | ~6 KB | ⭐⭐⭐⭐☆ |
| **README.md** | 📚 Документация проекта | ~12 KB | ⭐⭐⭐⭐☆ |
| **img/image.png** | 🌄 Изображение главного экрана | ~150 KB | ⭐⭐⭐☆☆ |
